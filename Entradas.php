...
<li><a style="font-size: 15px" class="active" href="Entradas.php">Entradas</a></li>
...
$imprime_tabla= "SELECT entradas_e.id_en, entradas_e.fecha_entrada, entradas_e.hora_entrada, entradas_e.usuario_u, espacios_e.nombre_e FROM entradas_e INNER JOIN espacios_e ON entradas_e.id_e = espacios_e.id_e";
