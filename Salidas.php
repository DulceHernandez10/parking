...
<li><a style="font-size: 15px" class="active" href="Salidas.php">Salidas</a></li>
...
$imprime_tabla= "SELECT id_sa, fecha_salida, hora_salida, espacio, usuario FROM salidas_e";
